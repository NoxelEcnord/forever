...
header: proto.Message.InteractiveMessage.Header.create({
    ...(await prepareWAMessageMedia({ image : fs.readFileSync('../../media/balochx.png')}, { upload: Fox.waUploadToServer})), 
      title: ``,
      gifPlayback: true,
      subtitle: "",
...
┗━━━━━━━━━━━━━━━⪼
  ...
  image: fs.readFileSync('../../media/balochx.png'), 
  caption: str, 
  contextInfo: {
    mentionedJid: [m.sender], 
    forwardingScore: 9999,
